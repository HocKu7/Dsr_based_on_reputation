...
private:
  ...
  //  |                            Address[1]                         |
  //  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  //  |        Count interactions     |           Address[2]          |
  //  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  //  |          Address[2]           |     Count interactions        |
  //  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  //  |                            Address[3]                         |
  //  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  //  |                               ...                             |
...
class DsrOptionResponceRep : public DsrOptionRerrHeader
{
public:
   ...
   * \brief Constructor.
   */
  DsrOptionResponceRep ();
  /**
   * \brief Destructor.
   */
  virtual ~DsrOptionResponceRep ();
  /**
   * \brief Set the route error source address
   * \param errorSrcAddress The error source address
   */
